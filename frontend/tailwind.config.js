...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      colors: {
        blood:   { DEFAULT: '#74101f', light: '#c52b40', dark: '#3e080f' },
        bone:    { DEFAULT: '#f1ebe6', dark: '#b7aaa5' },
        void:    { DEFAULT: '#070506', mid: '#0d0809', surface: '#120a0c', elevated: '#1a0d10' },
        crimson: '#c52b40',
        rust:    '#7f2630',
        purple:  { DEFAULT: '#74101f', light: '#a31e32', dark: '#26060b' },
        ash:     '#8e8180',
      },
      fontFamily: {
