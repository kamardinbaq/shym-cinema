...
const T = {
  ru: {
    ...
    rulesTitle: 'ПРАВИЛА',
    reviewsTitle: 'ОТЗЫВЫ',
    description: `Устали от обычных кинотеатров, где можно спокойно сидеть в кресле и просто смотреть фильм?
...
• Напитки и снэки`,
  ...
  kz: {
    ...
    description: `Кәдімгі кинотеатрлардан шаршадыңыз ба, онда сіз тыныш отыра аласыз және жай ғана фильм көре аласыз ба?
